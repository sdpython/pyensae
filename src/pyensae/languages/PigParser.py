...
class PigParser (Parser):
    ...
    def statement(self):
        ...
        try:
            ...
            if token in [PigParser.LOAD, PigParser.FILTER,
                         PigParser.DISTINCT, PigParser.STORE, PigParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 1)
                self.state = 124
    ...
    class Op_clauseContext(ParserRuleContext):
        ...
        def distinct_clause(self):
            return self.getTypedRuleContext(
                PigParser.Distinct_clauseContext, 0)
    ...
    def type(self):
        ...
        try:
            self.state = 197
            token = self._input.LA(1)
            if token in [PigParser.INT, PigParser.LONG, PigParser.FLOAT,
                         PigParser.DOUBLE, PigParser.CHARARRAY, PigParser.BYTEARRAY]:
                self.enterOuterAlt(localctx, 1)
                self.state = 193
                self.simple_type()
    ...
    def simple_type(self):
        ...
        try:
            ...
            self.state = 199
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PigParser.INT) | (1 << PigParser.LONG) | (
                    1 << PigParser.FLOAT) | (1 << PigParser.DOUBLE) | (1 << PigParser.CHARARRAY) | (1 << PigParser.BYTEARRAY))) != 0)):
    ...
    class Unary_condContext(ParserRuleContext):
        ...
        def null_check_cond(self):
            return self.getTypedRuleContext(
                PigParser.Null_check_condContext, 0)
        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    self.state = 321
                    _la = self._input.LA(1)
                    if not(((((_la - 86)) & ~0x3f) == 0 and ((1 << (_la - 86)) & ((1 << (PigParser.DIV - 86))
                                                                                  | (1 << (PigParser.PERCENT - 86)) | (1 << (PigParser.START - 86)))) != 0)):
                        self._errHandler.recoverInline(self)
                    self.consume()
                    self.state = 322
                    self.cast_expr()
    ...
    class Var_exprContext(ParserRuleContext):
        ...
        def projectable_expr(self):
            return self.getTypedRuleContext(
                PigParser.Projectable_exprContext, 0)
    ...
    def dot_proj(self):
        ...
        try:
            ...
            if token in [PigParser.PERIOD]:
                ...
                token = self._input.LA(1)
                if token in [
                        PigParser.GROUP, PigParser.IDENTIFIER, PigParser.DOLLAR]:
                    self.state = 368
                    self.col_ref()
    ...
    def scalar(self):
        ...
        try:
            ...
            self.state = 433
            _la = self._input.LA(1)
            if not(((((_la - 45)) & ~0x3f) == 0 and ((1 << (_la - 45)) & ((1 << (PigParser.NULL - 45)) | (1 << (PigParser.INTEGER - 45)) | (1 <<
                                                                                                                                            (PigParser.DOUBLENUMBER - 45)) | (1 << (PigParser.FLOATNUMBER - 45)) | (1 << (PigParser.QUOTEDSTRING - 45)) | (1 << (PigParser.LONGINEGER - 45)))) != 0)):
                self._errHandler.recoverInline(self)
            self.consume()
        except RecognitionException as re:
            localctx.exception = re
    ...
    def map(self):
        ...
        try:
            ...
            if token in [PigParser.LEFT_BRACKET]:
                ...
                self.state = 444
                _la = self._input.LA(1)
                if ((((_la - 29)) & ~0x3f) == 0 and ((1 << (_la - 29)) & ((1 << (PigParser.NOT - 29))
                                                                          | (1 << (PigParser.NULL - 29)) | (1 << (PigParser.QUOTEDSTRING - 29)))) != 0):
                    self.state = 436
                    self.keyvalue()
                    self.state = 441
                    self._errHandler.sync(self)
    ...
    def tuple(self):
        ...
        try:
            ...
            if token in [PigParser.LEFT_PAREN]:
                ...
                self.state = 499
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PigParser.NOT) | (1 << PigParser.NULL) | (1 << PigParser.INTEGER))) != 0) or ((((_la - 65)) & ~0x3f) == 0 and ((1 << (_la - 65)) & ((1 << (PigParser.DOUBLENUMBER - 65)) | (1 <<
                                                                                                                                                                                                                                              (PigParser.FLOATNUMBER - 65)) | (1 << (PigParser.QUOTEDSTRING - 65)) | (1 << (PigParser.LEFT_PAREN - 65)) | (1 << (PigParser.LEFT_BRACKET - 65)) | (1 << (PigParser.LONGINEGER - 65)) | (1 << (PigParser.LEFT_CURLY - 65)))) != 0):
                    self.state = 491
                    self.const_expr()
                    self.state = 496
                    self._errHandler.sync(self)
